...
class worldStateBuilder {
    ...
    #initialiseBrigades(state) {
        ...
        const CATEGORIES = [DIVISION.INFANTRY_RESERVE, DIVISION.HEAVY_CAV_RESERVE, DIVISION.LIGHT_CAV_RESERVE, DIVISION.SHORT_RANGE_FIRE_SUPPORT_RESERVE, DIVISION.AIR_DEFENCE_RESERVE, DIVISION.SENSOR_RESERVE, DIVISION.MAINTENANCE_RESERVE, ENGINEERING.ENGINEERING_RESERVE];
