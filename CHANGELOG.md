...
- Construction & production fixes
    ...
    - FishBot now sizes its factories and research labs on how many its oil income can keep working, instead of flipping between a minimum and a maximum at a single oil threshold.
- Technical changes
