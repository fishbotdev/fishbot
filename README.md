...
* `Sk-Rush2` (98% duel, 68% FFA)
* `Sk-UrbanDuel` (97% duel, 80% FFA)
* `Sk-Mountain` (98% duel, 62% FFA)
* `Sk-Valley` (94% duel, 78% FFA)
* `Sk-FishNets` (83% duel, **35% FFA**) - does not handle being attacked over water obstacles well
* `Sk-GreatRift` (99% duel, 40% FFA)
* `Sk-RollingHills` (89% duel, 78% FFA) 
* `Sk-Basingstoke` (92% duel, 69% FFA)
* `Sk-LittleEgypt` (90% duel, 46% FFA) 
* `Sk-Cockpit` - (100% duel, 65% FFA)
* `Sk-Urban-Chaos` (95% duel, 72% FFA)
* `Sk-Pyramidal` (100% duel, 68% FFA)
